  ...
  return (
    <div className="min-h-screen bg-black text-white grid place-items-center px-8 py-24">
      <div className="text-center max-w-lg">
        ...
        <p className="text-sm text-white/60 font-light mt-4">The page you sought does not exist. Return to Leader Builder.</p>
        <a href="/northform-atelier/" className="mt-8 inline-flex bg-white text-black rounded-full px-6 py-3 text-sm font-medium">Back to Leader Builder →</a>
      </div>
    </div>
  );
}
