  ...
  return (
    <div className="min-h-screen bg-black text-white px-8 md:px-16 lg:px-20 py-24">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-sm text-white/50 mt-2">Last updated: 8 Sep 2026 — Northform Atelier, Chennai & Dubai</p>
        <div className="mt-8 space-y-6 text-sm font-light leading-relaxed text-white/80">
          <p>Northform Atelier (“we”, “us”) respects your privacy. This policy explains what we collect when you request a private consultation, browse maisons, or watch atelier films.</p>
          ...
          <p>Email <a href="mailto:hello@northform.example" className="underline decoration-white/30">hello@northform.example</a> to access, correct, or delete your data. We retain consultation records for 24 months unless you ask to delete sooner.</p>
          <h2 className="font-heading italic text-2xl text-white mt-8">Contact</h2>
          <p>Northform Atelier, 12/4 OMR, Chennai 600041 — +91 98765 43210.</p>
        </div>
      </div>
    </div>
  );
